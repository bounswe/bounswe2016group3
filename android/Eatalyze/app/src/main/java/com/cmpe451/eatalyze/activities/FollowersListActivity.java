...
public class FollowersListActivity extends BaseActivity {
    ...
    public void Selected(int position){
        ...
        if(userList_.get(position).getUserType()==0) {
            Intent intent = new Intent(FollowersListActivity.this, UserProfilePageActivity.class);
           ...
           // finish();
            ...
            Intent intent = new Intent(FollowersListActivity.this, FoodServerProfilePageActivity.class);
            Bundle bundle = new Bundle();
            bundle.putLong("userid", user_id);
            intent.putExtras(bundle);
            startActivity(intent);
