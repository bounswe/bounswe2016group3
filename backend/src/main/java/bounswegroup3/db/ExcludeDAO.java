...
public abstract class ExcludeDAO {
	...
	protected abstract void deleteUserExcludes(@Bind("id") Long id);
	
	@SqlUpdate("delete from includes where user_id = :id")
	protected abstract void deleteUserIncludes(@Bind("id") Long id);
	...
	@SqlUpdate("insert into excludes (name, user_id) values (:name, :id)")
	protected abstract void addExclude(@Bind("id") Long id, @Bind("name") String name);
	
	@SqlUpdate("insert into includes (name, user_id) values (:name, :id)")
	protected abstract void addInclude(@Bind("id") Long id, @Bind("name") String name);
